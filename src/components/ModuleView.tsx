      ...
      <div className="py-12 max-w-lg mx-auto text-center space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl sm:text-2xl font-bold text-stone-900">
            {language === 'lo' ? 'ໂມດູນນີ້ຕ້ອງການລະຫັດເຂົ້າຮຽນ' : 'Accès réservé : Code requis'}
          </h2>
          <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
            {language === 'lo'
              ? `ໂມດູນນີ້ຢູ່ໃນແພັກເກດທີ ${module.tierRequired}. ກະລຸນາປ້ອນລະຫັດເຂົ້າຮຽນຂອງທ່ານ ຫຼື ສະໝັກຮຽນເພື່ອຮັບລະຫັດທັນທີ`
        ...
        <div className="flex justify-center space-x-3">
          ...
          >
            {language === 'lo' ? 'ກັບຄືນໜ້າທຳອິດ' : 'Retour à l\'accueil'}
          </button>
          <button
          ...
          >
            {language === 'lo' ? 'ປ້ອນລະຫັດເຂົ້າຮຽນ' : 'Saisir un code'}
          </button>
        </div>
      </div>
    );
    ...
    <div className="space-y-6 pb-20">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <span className="text-[11px] font-bold uppercase tracking-wider text-rose-600">
              {language === 'lo' ? module.lo.badge : module.fr.badge}
            </span>
            <h1 className="text-lg sm:text-xl font-bold text-stone-900 leading-tight">
              {language === 'lo' ? module.lo.title : module.fr.title}
            </h1>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2 p-1 bg-stone-100 rounded-2xl">
        ...
        >
          ...
          <span className="truncate">{language === 'lo' ? 'ບົດຮຽນ' : 'Chapitres'}</span>
        </button>
        ...
        >
          ...
          <span className="truncate">{language === 'lo' ? 'ແບບເຝິກຫັດ' : 'Atelier'}</span>
        </button>
        ...
        >
          ...
          <span className="truncate">{language === 'lo' ? 'ເຊັກລິສ' : 'Checklist'}</span>
        </button>
      </div>
            ...
            {module.chapters.map((ch, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <span>
                    {language === 'lo' ? `ບົດທີ ${idx + 1}` : `Ch. ${idx + 1}`}
                  </span>
                </button>
              );
            })}
